 ...
 * Inputs: None
 * Outputs: Updates sensorData.sensor5/6/7/8
 * Notes:
...
void readVL53L0X() {
  ...
  lox1.rangingTest(&measure[0], false);        // Read sensor 5
  lox2.rangingTest(&measure[1], false);        // Read sensor 6
  lox3.rangingTest(&measure[2], false);        // Read sensor 7
  lox4.rangingTest(&measure[3], false);        // Read sensor 8
  ...
  // Serial.print("IR7: "); Serial.println(sensorData.sensor7);
  // Serial.print("IR8: "); Serial.println(sensorData.sensor8);
}
